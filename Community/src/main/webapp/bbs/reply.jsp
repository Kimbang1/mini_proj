...
<%
if (session.getAttribute("uidSession") == null)
		...
		<main id="main" class="dFlex">
			...
			<div id="lnb">
				...
				<div id="contents" class="reply">
					...
					<!-- 답변페이지 내용 출력 시작 -->
					<form name="replyFrm" action="replyProc" method="get" id="replyFrm">
						...
						<table id="replyTbl">
							<tbody id="replyTblBody">
								<tr>
									<td class="req">작성자</td>
									<td><%=replyName%>[<span class="ori_Txt">원본 작성자 : <b><%=uName%></b>
									</span> ]</td>
								</tr>
								<tr>
									<td class="req">제목</td>
									<td><input type="text" name="subject" value="" size="50"
										id="subject"> (<span class="ori_Txt">원본 제목 : <b><%=subject%></b></span>
										)</td>
								</tr>
								<tr>
									<td style="vertical-align: top;">내용</td>
									<td><textarea name="content" id="txtArea" cols="89"
											wrap="hard"></textarea> <span id="ori_SpanTxtArea"
										class="ori_Txt">원본 글내용</span> <textarea id="ori_TxtArea"
											cols="89" readonly><%=content%></textarea></td>
								</tr>
							</tbody>
							<tfoot>
								<tr>
						...
						<input type="hidden" name="uid" value="<%=uid%>"> <input
							type="hidden" name="uname" value="<%=replyName%>"> <input
							type="hidden" name="ref" value="<%=ref%>"> <input
							type="hidden" name="depth" value="<%=depth%>"> <input
							type="hidden" name="pos" value="<%=pos%>"> <input
							type="hidden" name="nowPage" value="<%=nowPage%>" id="nowPage">
						<input type="hidden" name="ip"
							value="<%=request.getRemoteAddr()%>">

						<!-- 검색어전송 시작 -->
						<input type="hidden" id="keyField" name="keyField"
							value="<%=keyField%>"> <input type="hidden" id="keyWord"
